...
const config: SiteConfig = {
  ...
  site: 'https://adityakarn.github.io/blog/',
  // The name of your site, used in the title and for SEO.
  title: 'Blog',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Trying to write whatever i am fixating on these days',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/adityakarn',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/adityakarn',
    email: 'adityakarn26@gmail.com',
    linkedin: 'https://www.linkedin.com/in/aditya-kumar-2605/',
